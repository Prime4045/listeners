      ...
      <div className="auth-container">
        ...
        <div className="auth-branding">
          <div className="branding-content">
            ...
            <h2 className="branding-title">Join millions of music lovers</h2>
            <p className="branding-subtitle">
              Create your account and start discovering amazing music, creating playlists, and connecting with artists.
            </p>
